...
public class JacksonMapper {
    /** 记录日志的变量 */
	protected final static Logger logger = LoggerFactory.getLogger(JacksonMapper.class);
    /** 静态ObjectMapper */
	...
	public static  <T> T mapToBean(Object vo,Class<T> cls){
		return ParameterUtil.mapToBean(vo, cls);
	}
	

	
	public static  <T> List<T> mapToList(Object vo,Class<T> cls){
		return ParameterUtil.toListBean(vo, cls);
	}
	 ...
	 * @return
	 */
	public static  <T> List<T> convertToList(Object vo,Class<T> cls){
		return ParameterUtil.toListBean(vo, cls);
	}
}
